...
const catalog = [
  {
    ...
    images: [
      '/images/products/617O_RkwdPL__SL1500__1789824619904_7xt58rx2unx.jpg',
      '/images/products/61RT4wGIoQL__SL1500__1789824619905_4hq6p52gqap.jpg',
    ],
    variants: [
      ['Storage', '128GB', 0],
      ['Storage', '256GB', 100],
  ...
  },
  {
    ...
    slug: 'jbltune',
    description: 'Immersive JBL wireless headphones with adaptive noise cancelling and all-day comfort.',
    content:
      'Bring your playlists to life with JBL Tune 770NC headphones, designed for comfortable listening, clear sound, and reliable everyday use.',
    price: 149.99,
    comparePrice: 179.99,
    costPrice: 90,
    brand: 'JBL',
    ...
    categorySlug: 'audio',
    sku: 'WH-NC-BLK-BT',
    tags: ['audio', 'headphones', 'jbl', 'wireless', 'bluetooth'],
    seoTitle: 'JBL Tune 770NC Headphones | NOVA/MARKET',
    seoDescription:
      'Shop JBL Tune 770NC wireless headphones with immersive sound and comfortable all-day listening.',
    images: [
      '/images/products/JBL%20headphone/613dCuN%2BBSL._SL1500_.jpg',
      '/images/products/JBL%20headphone/61GtodeXqtL._SL1500_.jpg',
      '/images/products/JBL%20headphone/61JU2HicMQL._SL1500_.jpg',
      '/images/products/JBL%20headphone/61YZskEsZKL._SL1500_.jpg',
    ],
    variants: [] as const,
  },
] as const;
